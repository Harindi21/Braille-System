    ...
    public class Pattern
    {
        ...
        public string ShapePerimeters(string name, string measure, string radius, string sideLength, string length, string height, string tr1, string tr2, string tr3, string pentL, string hexL, string heptL, string octL, string nongL, string Pl1, string Pl2, string Pl3, string Pl4, string Tz1, string Tz2, string Tz3, string Tz4, string Rh1, string Rh2, string Rh3, string Rh4, string Ql1, string Ql2, string Ql3, string Ql4)
        {
            if (name == "Circle")
            {
                ...
                {
                    case "cm":
                        p2 += "<span class='red-text'>Perimeter: " + p.ToString() + " cm\n</span>";
                        break;
                    case "m":
                        p2 += "<span class='red-text'>Perimeter: " + p.ToString() + " m\n</span>";
                        break;
                    case "mm":
                        p2 += "<span class='red-text'>Perimeter: " + p.ToString() + " mm\n</span>";
                        break;
                    case "km":
                        p2 += "<span class='red-text'>Perimeter: " + p.ToString() + " km\n</span>";
                        break;
                    case "ft":
                        p2 += "<span class='red-text'>Perimeter: " + p.ToString() + " ft\n</span>";
                        break;
                    case "yd":
                        p2 += "<span class='red-text'>Perimeter: " + p.ToString() + " yd\n</span>";
                        break;
                    case "in":
                        p2 += "<span class='red-text'>Perimeter: " + p.ToString() + " in\n</span>";
                        break;
                }
                return p2;
            }
            ...
            {
                string p2 = "";
                double p0 = (Convert.ToDouble(length)  + Convert.ToDouble(height));
                double p = p0 * 2;
                switch (measure)
                {
                    case "cm":
